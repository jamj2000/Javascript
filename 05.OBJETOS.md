...
- En algunos casos muy poco habituales, en NextJS, [al pasar información desde un componente servidor a un componente cliente o viceversa](https://react.dev/reference/rsc/use-server#serializable-parameters-and-return-values)
