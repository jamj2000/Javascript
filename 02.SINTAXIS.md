...
> **NOTA**:
>
> También existen lost tipos `Boolean` y `BigInt`, y algunos más. Para más detalles consultar: https://developer.mozilla.org/es/docs/Web/JavaScript/Data_structures 
