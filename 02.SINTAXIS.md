...
Es frecuente realizar conversiones de un **Array a String**. Para ello se aplica el método **join** al array. El método join recibe una cadena de texto como separador.
...
También es frecuente realizar conversiones de un **String a Array**. Para ello se aplica el método **split** al string. El método split recibe una cadena de texto como separador.
