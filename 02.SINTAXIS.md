...
Las 2 primeras son equivalentes. Es aconsejable utilizar siempre la misma forma.
...
La tercera forma se conoce como `template string` y fue introducida con ES2015. Permite mostrar valor de variables y ejecutar código javascript sin tener que salir de la cadena de texto. 
