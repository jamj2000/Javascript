...
Pero para datos complejos, como arrays y objetos, el significado es ligeramente distinto. Al igual que otros lenguajes, en Javascript cuando trabajamos con arrays y objetos, realmente estamos trabajando con referencias en memoria. **Para arrays y objetos lo que no puede modificarse es la referencia en memoria. Pero si es posible modificar elementos individuales dentro del array u objeto.** 
