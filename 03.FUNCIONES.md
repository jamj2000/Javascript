...
Es la forma clásica. Aún así esta forma todavía es ampliamente usada.
...
Una misma método puede definir más de un callback. A continuación el método `getCurrentPosition` con 2 callbacks. Se muestran 3 formas de uso.

*Forma 1: con funciones con nombre*
```javascript
